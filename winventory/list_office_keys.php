...
echo " <tr>\n  <td align=\"left\" class=\"contenthead\" >List all MS Office CD Keys.<br />&nbsp;</td>\n";
if ($count_system <> "10000"){
  echo "  <td align=\"right\">\n";
  echo "    <a href=\"list_office_keys.php?page_count=" . $page_prev . "&amp;sort=" . $sort . "\"><img src=\"" . $but_bac . "\" alt=\"Previous " . $count_system . " Systems\" title=\"Previous " . $count_system . " Systems\" border=\"0\" width=\"16\" height=\"16\" /></a>&nbsp;&nbsp;&nbsp;\n"; 
  echo "    <a href=\"list_office_keys.php?page_count=0&amp;show_all=1&amp;sort=" . $sort . "\"><img src=\"" . $but_all . "\" alt=\"All Systems\" title=\"All Systems\" border=\"0\" width=\"16\" height=\"16\" /></a>&nbsp;&nbsp;&nbsp;\n"; 
  echo "    <a href=\"list_office_keys.php?page_count=" . $page_next . "&amp;sort=" . $sort . "\"><img src=\"" . $but_for . "\" alt=\"Next " . $count_system . " Systems\" title=\"Next " . $count_system . " Systems\" border=\"0\" width=\"16\" height=\"16\" /></a>&nbsp;<br />&nbsp;\n  </td>\n"; 
} else {}
echo " </tr>\n</table>\n";
...
if (($sort == "system_name") OR ($sort == "net_ip_address")) {
  ...
  $sql = "SELECT ms_keys_uuid, ms_keys_name, ms_keys_cd_key, MAX(ms_keys_timestamp) FROM ms_keys WHERE ms_keys_key_type LIKE 'office%' GROUP BY ms_keys_uuid ORDER BY " . $sort;
}
...
if ($myrow = mysql_fetch_array($result)){
  echo "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"content\" width=\"100%\">\n";
  echo " <tr>\n";
  echo "  <td align=\"center\"><a href=\"list_office_keys.php?sub=" . $sub . "&amp;sort=net_ip_address\">IP Address </a></td>\n";
  echo "  <td align=\"center\"><a href=\"list_office_keys.php?sub=" . $sub . "&amp;sort=system_name\">Name</a></td>\n";
  echo "  <td align=\"center\"><a href=\"list_office_keys.php?sub=" . $sub . "&amp;sort=ms_keys_name\">Package</a></td>\n";
  echo "  <td align=\"center\"><a href=\"list_office_keys.php?sub=" . $sub . "&amp;sort=ms_keys_cd_key\">CD Key</a></td>\n";
  echo " </tr>\n";
  do {
    if (($sort == "system_name") OR ($sort == "net_ip_address")) {
