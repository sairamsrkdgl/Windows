...
if ($count_system <> "10000"){
  echo "  <td align=\"right\">\n";
  echo "    <a href=\"list_laptops.php?page_count=" . $page_prev . "&amp;sort=" . $sort . "\"><img src=\"" . $but_bac . "\" alt=\"Previous " . $count_system . " Systems\" title=\"Previous " . $count_system . " Systems\" border=\"0\" width=\"16\" height=\"16\" /></a>&nbsp;&nbsp;&nbsp;\n"; 
  echo "    <a href=\"list_laptops.php?page_count=0&amp;show_all=1&amp;sort=" . $sort . "\"><img src=\"" . $but_all . "\" alt=\"All Systems\" title=\"All Systems\" border=\"0\" width=\"16\" height=\"16\" /></a>&nbsp;&nbsp;&nbsp;\n"; 
  echo "    <a href=\"list_laptops.php?page_count=" . $page_next . "&amp;sort=" . $sort . "\"><img src=\"" . $but_for . "\" alt=\"Next " . $count_system . " Systems\" title=\"Next " . $count_system . " Systems\" border=\"0\" width=\"16\" height=\"16\" /></a>&nbsp;<br />&nbsp;\n  </td>\n"; 
} else {}
echo " </tr>\n</table>\n\n";
...
if ($show_os == "y")           { echo "  <td align=\"center\"><a href=\"list_laptops.php?sort=system_os_name&amp;page_count=" . $page_current . "\">OS</a></td>\n"; } else {}
if ($show_date_audited == "y") { echo "  <td align=\"center\"><a href=\"list_laptops.php?sort=system_timestamp&amp;page_count=" . $page_current . "\">Date Audited</a></td>\n"; } else {}
if ($show_type == "y")         { echo "  <td align=\"center\"><a href=\"list_laptops.php?sort=system_system_type&amp;page_count=" . $page_current . "\">&nbsp;System Type&nbsp;</a></td>\n"; } else {}
if ($show_description == "y")  { echo "  <td align=\"center\"><a href=\"list_laptops.php?sort=system_description&amp;page_count=" . $page_current . "\">&nbsp;System Description&nbsp;</a></td>\n"; } else {}
if ($show_domain == "y")       { echo "  <td align=\"center\"><a href=\"list_laptops.php?sort=net_domain\">&nbsp;Domain&nbsp;</a></td>\n"; } else {}
if ($show_service_pack == "y") { echo "  <td align=\"center\"><a href=\"list_laptops.php?sort=system_service_pack\">&nbsp;Service Pack&nbsp;</a></td>\n"; } else {}
echo " </tr>\n";
